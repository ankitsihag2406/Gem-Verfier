...
import { ExtractedParameter, getComplianceSummary } from "@/lib/mockData";
...
interface Props {
  ...
  onSelectParameter?: (p: ExtractedParameter) => void;
  selectedParamId?: string;
}

export default function ParameterTable({ parameters, onSelectParameter, selectedParamId }: Props) {
