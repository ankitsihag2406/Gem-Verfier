// ─── Mock Data Store ────────────────────────────────────────────────────────
// This is the central "database" for the frontend-only prototype.
// In the real system, this would come from the FastAPI backend.

export type ParameterStatus = "COMPLIANT" | "NON_COMPLIANT" | "FLAG_FOR_REVIEW" | "NOT_FOUND" | "PENDING";
...
export interface Bid {
  ...
  overallCompliance: "COMPLIANT" | "PARTIAL" | "NON_COMPLIANT" | "PROCESSING";
  parameters: ExtractedParameter[];
  pdfName: string;
  /** Average AI confidence across AI_VERIFIED parameters (0–1) */
  avgConfidence: number | null;
  /** Total time taken by the AI pipeline in seconds */
  processingTimeSec: number | null;
  /** Human-readable failure reason for FAILED bids */
...
const PENDING_PARAMETERS: ExtractedParameter[] = [
...
export const MOCK_BIDS: Bid[] = [
  // ── BID 1: Compliant ─────────────────────────────────────────────────────
  {
    ...
    parameters: [
      {
        id: "p1",
        parameterName: "Earnest Money Deposit (EMD)",
        extractedValue: "₹5,00,000",
        confidenceScore: 0.97,
        exactQuote: "We hereby enclose Earnest Money Deposit of Rs. 5,00,000 (Rupees Five Lakh Only) vide Demand Draft No. DD/2024/08/004521 dated 22nd August 2024, drawn on State Bank of India, New Delhi.",
        pageNumber: 3,
        status: "COMPLIANT",
        requirement: "Minimum ₹5,00,000 EMD required",
        category: "AI_VERIFIED",
      },
      {
        id: "p2",
        parameterName: "Years of Experience",
        extractedValue: "8 Years",
        confidenceScore: 0.94,
        exactQuote: "Apex Technology Solutions Pvt. Ltd. has been providing IT infrastructure solutions since 2016, accumulating over 8 years of experience in government sector deployments across 14 states.",
        pageNumber: 5,
        status: "COMPLIANT",
        requirement: "Minimum 5 years of relevant experience",
        category: "AI_VERIFIED",
      },
      {
        id: "p3",
        parameterName: "Annual Turnover",
        extractedValue: "₹2.4 Crore",
        confidenceScore: 0.96,
        exactQuote: "As per the audited financial statements for FY 2023-24, the company's annual turnover stands at INR 2,40,00,000 (Rupees Two Crore Forty Lakh), duly certified by M/s Sharma & Associates, Chartered Accountants.",
        pageNumber: 8,
        status: "COMPLIANT",
        requirement: "Minimum Annual Turnover of ₹1 Crore",
        category: "AI_VERIFIED",
      },
      ...PENDING_PARAMETERS,
    ],
    ...
    parameters: [
      {
        id: "p1",
        parameterName: "Earnest Money Deposit (EMD)",
        extractedValue: "₹4,50,000",
        confidenceScore: 0.98,
        exactQuote: "The Earnest Money Deposit of Rs. 4,50,000 (Rupees Four Lakh Fifty Thousand) is submitted herewith via NEFT transfer (UTR No. SBIN024082900012) to the designated GeM account.",
        pageNumber: 2,
      ...
      },
      {
        id: "p2",
        parameterName: "Years of Experience",
        extractedValue: "7 Years",
        confidenceScore: 0.91,
        exactQuote: "TechVision Enterprises Ltd. was established in 2017 and has been operational for 7 years, serving both private and public sector clients in IT hardware procurement.",
        pageNumber: 4,
        status: "COMPLIANT",
        requirement: "Minimum 5 years of relevant experience",
        category: "AI_VERIFIED",
      },
      {
        id: "p3",
        parameterName: "Annual Turnover",
        extractedValue: "₹1.85 Crore",
        confidenceScore: 0.93,
        exactQuote: "Total revenue from operations for the financial year 2023-24 amounts to INR 1,85,00,000 as per the Balance Sheet certified by M/s Verma & Co., Chartered Accountants, Delhi.",
        pageNumber: 7,
        status: "COMPLIANT",
        requirement: "Minimum Annual Turnover of ₹1 Crore",
        category: "AI_VERIFIED",
  ...
  // ── BID 3: Flagged (Ambiguous Experience + Missing Turnover) ─────────────
  {
    id: "bid-003",
    tenderId: "tender-001",
    ...
    parameters: [
      {
        ...
        exactQuote: "EMD of Rs. Five Lakh deposited via Pay Order No. 2024/PO/88821, State Bank of India, Branch: Connaught Place, New Delhi.",
        pageNumber: 3,
        status: "COMPLIANT",
        requirement: "Minimum ₹5,00,000 EMD required",
        category: "AI_VERIFIED",
      },
      {
        id: "p2",
        parameterName: "Years of Experience",
        extractedValue: "~3–5 Years (Ambiguous)",
        confidenceScore: 0.61,
        exactQuote: "Our organization has been involved in digital infrastructure and related services for several years, with our team members bringing extensive industry experience from their prior roles in various technology companies.",
        pageNumber: 6,
  ...
  // ── BID 4: FAILED — Unreadable / blurred scan ─────────────────────────────
  {
    id: "bid-004",
    tenderId: "tender-001",
...
export function getBidsByTender(tenderId: string): Bid[] {
...
export function formatProcessingTime(sec: number): string {
...
export function getComplianceSummary(parameters: ExtractedParameter[]) {
