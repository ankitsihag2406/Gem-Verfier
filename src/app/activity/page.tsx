...
// ── Build per-bid timeline events ─────────────────────────────────────────────
function buildTimeline(bid: typeof MOCK_BIDS[0]) {
  ...
  return [
    ...
    { icon: Brain,        color: "#7C3AED",         label: "AI requirements extraction",    detail: `${aiParams.length} parameters identified from tender`, time: t(44) },
    ...
    ...(flagged > 0 ? [{
      ...
      label: "Human review status assigned",
      detail: `${flagged} parameter(s) require manual verification`,
      time: t(63),
    }] : []),
  ];
}
    ...
    <AppShell>
      ...
      <div className="page-content">
        ...
        <div style={{
          ...
          borderLeft: "4px solid var(--gem-navy)", borderRadius: 6, marginBottom: 20,
        }}>
          <Activity size={14} color="var(--gem-navy)" style={{ flexShrink: 0 }} />
          <span style={{ fontSize: 13, color: "var(--text-body)", lineHeight: 1.5 }}>
            Complete, immutable record of every AI extraction and verification event.
            Each entry is traceable to the original document for regulatory compliance.
          </span>
          <span style={{
            marginLeft: "auto", fontSize: 11.5, fontWeight: 700,
            padding: "3px 10px", background: "#EFF6FF",
            border: "1px solid #BFDBFE", borderRadius: 4,
            color: "var(--gem-navy)", flexShrink: 0,
          }}>
            {MOCK_BIDS.length} bid(s) · {MOCK_BIDS.length * 5}+ events
          </span>
        </div>
                ...
                <div className="card-header">
                  ...
                  <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
                    <span style={{
                      ...
                      borderRadius: 4, color: overallColor,
                    }}>
                      ...
                      <div style={{ display: "flex", flexDirection: "column", alignItems: "center" }}>
                        ...
                        {i < events.length - 1 && (
                          <div style={{
                            ...
                            background: "var(--border-light)", marginTop: 4,
                          }} />
                        )}
                      </div>
