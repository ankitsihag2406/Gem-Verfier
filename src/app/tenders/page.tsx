...
import { MOCK_TENDERS, getBidsByTender, formatCurrency, Tender } from "@/lib/mockData";
    ...
    <div className="card" style={{ display: "flex", flexDirection: "column" }}>
      ...
      <div style={{ padding: "14px 16px", borderBottom: "1px solid var(--border-light)" }}>
        <div style={{ display: "flex", alignItems: "flex-start", justifyContent: "space-between", gap: 10, marginBottom: 8 }}>
          <div style={{
            width: 36, height: 36, borderRadius: 7, background: "#EFF6FF",
          ...
          <span style={{
            ...
            border: "1px solid #BBF7D0", textTransform: "uppercase" as const, letterSpacing: "0.04em",
          }}>Active</span>
        </div>
        <div style={{ fontSize: 13.5, fontWeight: 700, color: "var(--text-heading)", lineHeight: 1.4, marginBottom: 8 }}>
          {tender.name}
        </div>
      ...
      <div style={{ padding: "0 16px 14px", marginTop: "auto" }}>
        <Link href={`/tenders/${tender.id}`} className="btn btn-primary btn-sm" style={{ width: "100%", justifyContent: "center" }}>
